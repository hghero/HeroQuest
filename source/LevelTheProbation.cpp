...
LevelTheProbation::LevelTheProbation(uint num_heroes)
:
        Level(num_heroes)
{
	// NIX
...
LevelTheProbation::~LevelTheProbation()
{
	// NIX
}

QString LevelTheProbation::getName() const
{
    return prettyClassName();
}

QString LevelTheProbation::prettyClassName()
{
    return "The Probation";
}

void LevelTheProbation::placeHeroes()
{
 ...
 */
void LevelTheProbation::createMonsters()
{
 ...
 */
void LevelTheProbation::createDoors()
{
	// normal doors
 ...
 */
void LevelTheProbation::createTraps()
{
    // (no traps in this level)

	// pit traps
	//_traps.push_back(new PitTrap(HeroQuest::_hero_quest->getPlayground()->getQuestBoard(), NodeID(2, 17)));

	// spear traps
	//_traps.push_back(new SpearTrap(HeroQuest::_hero_quest->getPlayground()->getQuestBoard(), NodeID(0, 1)));
	//_traps.push_back(new SpearTrap(HeroQuest::_hero_quest->getPlayground()->getQuestBoard(), NodeID(0, 7)));
	//_traps.push_back(new SpearTrap(HeroQuest::_hero_quest->getPlayground()->getQuestBoard(), NodeID(2, 16)));
}

/*!
 * Create walkable and non-walkable decoration on the board.
 */
void LevelTheProbation::createDecoration()
{
...
void LevelTheProbation::createChestTreasureDescriptions()
{
    // chest A
...
QString LevelTheProbation::getLevelBriefing() const
{
 ...
 */
const Monster* LevelTheProbation::getRoamingMonsterType() const
{
